...
<asdf>
   <header>
      <name>System G (4+9+0)</name>
      <description>
				BBC RD BRIRs
				Auralise a live input through system G (4+9+0) from Rec. ITU-R BS.2051.
   ...
   <scene_setup>
      ...
      <source name="M+045" properties_file="irs/BBCRD_LR_M+045_SSR.wav">
         <port>2</port>
